...
export const MODELS: ModelConfig[] = [
  // === GRATUITOS (GOogle AI Studio) ===
  {
    ...
    cost: 'free',
    costEmoji: '🟢 FREE',
    description: 'Rápido e gratuito (Google AI Studio) — ideal para tarefas leves',
    requiresKey: true,
  ...
  },
  {
    ...
    cost: 'free',
    costEmoji: '🟢 NEW',
    description: 'Nova geração experimental — ultra-rápida',
    requiresKey: true,
    envVar: 'GOOGLE_GENERATIVE_AI_API_KEY',
    sdkPackage: '@ai-sdk/google',
    features: { tools: true, vision: true, streaming: true },
  ...
  // === BAIXO CUSTO ===
  {
    ...
    cost: 'low',
    costEmoji: '🟡 $',
    description: 'Raciocínio avançado e contexto gigante',
    requiresKey: true,
    envVar: 'GOOGLE_GENERATIVE_AI_API_KEY',
    sdkPackage: '@ai-sdk/google',
